ymaps.ready(function () {
    var myMap = new ymaps.Map('map', {
        ...
        clusterer = new ymaps.Clusterer({
            ...
            // This option is responsible for the cluster sizes. In this case, for clusters containing up to 100 elements, it will show a small icon. For the rest, a large icon will be shown.
            clusterNumbers: [100],
