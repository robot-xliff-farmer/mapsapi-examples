ymaps.ready(function () {
    // An example implementation of a custom control based on inheritance from collection.Item. The control displays the name of the object that is in the center of the map.
    ...
    ymaps.util.augment(CustomControlClass, ymaps.collection.Item, {
        ...
        _onServerResponse: function (result) {
            // The data has been received from the server and now it must be displayed. Description of the response in JSON format.
