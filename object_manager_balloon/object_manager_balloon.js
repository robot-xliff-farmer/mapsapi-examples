...
function init () {
    ...
    $.ajax({
        ...
        if (objectState.isClustered) {
            ...
            // All the generated clusters have unique identifiers. This identifier must be passed to the balloon manager to specify which cluster to show the balloon on.
