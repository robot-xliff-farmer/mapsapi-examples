ymaps.ready(function () {
    ...
    loadControl.events.add('click', function () {
        if (ymaps.Placemark) {
            ...
            // On-demand loading of the placemarks class and overlay. By default, the overlay is automatically loaded after you add placemarks to the map. In this example, the placemark module itself is loaded asynchronously and there is no need to load the overlay separately.
            ymaps.modules.require(['Placemark', 'overlay.Placemark'])
                .spread(function (Placemark, PlacemarkOverlay) {
                    // Adding the class manually to the global viewport, since this does not happen when using the "require" method of the module system.
